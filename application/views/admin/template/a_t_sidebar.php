<div id="sidebar" class="col-9 col-sm-5 col-lg-3 sidebar h-100 position-fixed" style="display: none;">
	<div class="list-group mt-4" style="display: none;">
		<a href="dashboard" class="list-group-item side_link py-3 px-4 dashboard">
			<i class="fa fa-home" aria-hidden="true"></i> Dashboard
		</a>
	</div>
	<div class="list-group mt-2" style="display: none;">
		<a href="products" class="list-group-item side_link py-3 px-4 products">
			<i class="fa fa-shopping-bag" aria-hidden="true"></i> Products
		</a>
		<a href="types" class="list-group-item side_link py-3 px-4 types">
			<i class="fa fa-tags" aria-hidden="true"></i> Types
		</a>
		<a href="orders" class="list-group-item side_link py-3 px-4 orders">
